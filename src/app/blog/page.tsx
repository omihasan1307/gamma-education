                      ...
                      <Link href={`/blog/${blog.id}`} aria-label={`Link to blog ${blog.title}`} legacyBehavior>
                        <a>
                          <div className="relative flex items-end overflow-hidden rounded-xl">
                            <Image src={blog.featured_image || img.noImage} alt={blog.title} width={400} height={300} loading="eager" />
                          </div>
                          <div className="space-y-2 py-5 px-5 bg-slate-100">
                            ...
                            <p className="text-gray-500">{blog.subtitle?.length > 55 ? blog.subtitle?.slice(0, 55) + "..." : blog.subtitle}</p>
                          </div>
                        </a>
                      </Link>
                    </div>
