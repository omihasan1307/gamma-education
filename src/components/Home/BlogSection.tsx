...
const BlogSection = async ({ blogs }: { blogs: any }) => {
  return (
    <div className="max-w-screen-xl mx-auto py-28 px-2 ">
      <div className="flex items-center justify-center flex-col text-center space-y-5">
        <SectionHeader text="Checkout Out Blogs" icon={RiServiceFill} />
        <div className="text-5xl leading-tight">
          Explore Our <span className="font-bold hover:text-sk"> Blogs</span>
        </div>
        <p className="text-gray-500">Get knowledge about binary hooks by our blogs</p>
      </div>
