...
const menuItems = [
  ...
  { id: 3, title: "Portfolio", link: "/gallery" },
...
const Navbar = () => {
  ...
  return (
    <div
      className={`${
        isSticky
          ? "fixed top-0 left-0 right-0 shadow-lg z-50 bg-white"
          : "relative bg-[#F7F8FA] "
      }`}
    >
      <nav className="max-w-screen-xl mx-auto transition-all duration-300 ">
        <div className="flex items-center justify-between ">
          <Link href={"/"}>
            <Image src={img.Logo} alt="Logo" width={150} height={200} />
          </Link>
          ...
          <Link href={"/inquiry"}>
            <button className="px-6 py-3 rounded-lg bg-gradient-custom text-white font-semibold">
              Let&apos;s Collaborate
            </button>
          </Link>

          <div
            className="lg:hidden block cursor-pointer pe-5 lg:pe-0"
